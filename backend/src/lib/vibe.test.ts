...
describe('analyzeVibe', () => {
  describe('sentiment', () => {
    it('is positive when positive keywords dominate', () => {
      expect(analyzeVibe('We shipped a great, clean launch').sentiment).toBe('positive');
    });
    ...
    it('is neutral when there are no sentiment keywords', () => {
      expect(analyzeVibe('A standard internal planning document').sentiment).toBe('neutral');
    });
